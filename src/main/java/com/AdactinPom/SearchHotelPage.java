...
public interface SearchHotelPage {
	...
	String searchhotel_roomnos_id = "room_nos";
	String searchhotel_checkin_id = "datepick_in";
	String searchhotel_checkout_id = "datepick_out";
	String searchhotel_adults_id = "adult_room";
